...
const AboutPage = () => {
	...
	return (
		<>
			...
			<Helmet>
				<title>About Lovlit | Handmade Gifts & Jewelry</title>

				<meta
					name="description"
					content="Learn about Lovlit, our handmade jewelry, aesthetic gifts, candles, bouquets and the story behind our brand."
				/>
			</Helmet>
			<div
